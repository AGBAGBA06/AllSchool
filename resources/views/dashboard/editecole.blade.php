          ...
          <div class="col-lg">
            ...
            <div class="card">
             ...
             @endif
                ...
                <form action="{{ url('/modifierecole')}}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="row mb-4">
                    <label for="inputText" class="col-sm-2 col-form-label">Nom ecole</label>
                    <div class="col-sm-8">
                      <input type="text" value="{{$ecole->nom}}"  name="nom" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{$ecole->directeur}}" name="directeur" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <select class="form-select" value="{{$ecole->type}}"  name="type" aria-label="Default select example">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <select class="form-select" value="{{$ecole->niveau_scolaire}}"  name="niveau_scolaire" aria-label="Default select example">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input class="form-control" value="{{$ecole->image_couverture}}"  name="image_couverture" type="file" id="formFile">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text"  name="address" value="{{$ecole->address}}" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text"  name="domaine" value="{{$ecole->domaine}}" placeholder="exemple:scolaire,informatique,etc" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text"  name="ville" value="{{$ecole->ville}}" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text"  name="tel" value="{{$ecole->tel}}" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{$ecole->resultatcep}}" name="resultatcep" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{$ecole->resultatbepc}}"  name="resultatbepc" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <input type="text" value="{{$ecole->resultatbac}}" name="resultatbac" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" value="{{$ecole->description}}" name="description" style="height: 100px"></textarea>
                    </div>
                   </div>
